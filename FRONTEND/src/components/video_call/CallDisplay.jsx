...
function CallDisplay({current_caller, socket, message, ice_list}) {
  return (
    <div className="call_display">
      <div className="call_accept" onClick = {
        () => {
            receiveCall(socket, message, ice_list, current_caller)
        }
      }>
        <svg
